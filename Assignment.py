...
def main():
    ...
    if len(sys.argv) != 2:
        print("Usage: python script.py <C:\Users\ayush\OneDrive\Documents\GitHub\COMP593-Lab03\Salesdata.py>")
        sys.exit(1)

    csv_file_path = sys.argv[1]
    if not os.path.isfile(csv_file_path):
        print(f"C:\Users\ayush\OneDrive\Documents\GitHub\COMP593-Lab03\Salesdata.py: The file {csv_file_path} does not exist.")
        sys.exit(1)
